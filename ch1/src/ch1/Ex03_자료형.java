...
/*
    ...
    - 자료형
        ...
        2) new를 이용해서 생성하면(참조자료형) 그냥 heap 영역에 저장된다. 끝
    ...
    1) 기본자료형(Primitive type)
        ...
        문자형: char, (16bit = 2byte)
                기본값: '\u0000'
                *주의: 따옴표. 문자 하나를 의미
                    (이제부터 쌍따옴표는 문자열(String) 이라는 자료형을 뜻함)
    ...
    2) 참조자료형(Reference type) - 객체의 주소를 저장한다.
        ...
        클래스 이름으로 변수 타입을 쓰면 그게 다 참조변수(이부분 변수랑 클래스 부분 하면 이해 될거임.)
        (Ex01에서 new Main3() 로 해봤었던거임)

...
/* 지피티와 딥시크가 딱지를 접고 있음
    ...
    할거: 1)지금 입력하는 값이 정사각형용인지 직사각형용인지 먼저 선택하고
         2)딱지 가로세로 길이 입력 박기 -> 딱지 면적 구하기
        (단, 딱지 종류는 직사각형, 정사각형 두가지임)
        직사각형: 숫자 두개 입력받아서 (가로 * 세로)
        정사각형: 숫자 한개 입력박고 (숫자 * 숫자)

    ==> 상속과 다형성을 얼마나 이해를했는지 알아보기 위한 에제
*/

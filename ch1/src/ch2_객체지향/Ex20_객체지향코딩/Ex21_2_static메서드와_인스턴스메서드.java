...
public class Ex21_2_static메서드와_인스턴스메서드 {
    public static void main(String[] args) {
        ...
        System.out.println(C.num2); //  num2 가 C 안에 있고, C가 아직 인스턴스화 되지 않았지만 그래도 static 이라서 메모리에 C.num2=10 처럼 들어가 있어서 인스턴스화 하기 전에도 사용 가능
...
//        firstMethod();
    ...
    void firstMethod() {
        ...
        Ex21_2_static메서드와_인스턴스메서드.secondMethod();
